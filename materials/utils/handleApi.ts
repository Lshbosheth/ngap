...
import { getEnv, handleArrayVariable, renderFormula, renderTemplate, renderAsyncFormula } from './util';
import { get } from 'lodash-es';
import qs from 'qs';
import { isObject } from 'lodash-es';
import { isPlainObject } from 'lodash-es';
import getFieldFromAPI from './apiUtilForInterface';
/**
...
export const handleApi = async (
    ...
    if (api.sourceType === 'json') {
        ...
        if (api.name?.value) {
            ...
            const value = renderAsyncFormula(api.name?.value, {}, forEachData);
