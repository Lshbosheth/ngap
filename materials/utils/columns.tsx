...
import { ActionType } from '@materials/Scene/BusinessTable/TagSetting/TriggerEventItem';

type IconConfig = { iconUrl: string; showTooltip?: boolean; tooltipContent?: string; columns?: string[] };
