import { useState, useImperativeHandle, forwardRef, memo, useMemo, CSSProperties, ForwardedRef, useEffect } from 'react';
...
const TimelineCus = (props: any, ref: ForwardedRef<RefConfig>) => {
    ...
    return (
        visible && (
            <Spin spinning={loading} data-id={id} data-type={type} size="large" wrapperClassName="spin-loading">
                <Timeline {...propsConf} items={dataList} style={{ ...config.style, ...mStyle, paddingTop: 10 }} />
            </Spin>
        )
    );
};
