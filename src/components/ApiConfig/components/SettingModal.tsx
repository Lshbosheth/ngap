...
const SettingModal = ({ update }: SettingModalProp, ref: any) => {
    ...
    const { apis, addApi, updateApi } = pageStore(
    ...
    return (
        <Modal width={'800px'} okText="确认" cancelText="取消" title="接口配置" open={open} onOk={handleOk} onCancel={handleCancel} destroyOnClose>
