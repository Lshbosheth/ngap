...
const InterceptorModal = ({ update }: SettingModalProp, ref: any) => {
    ...
    const { interceptor, setInterceptor } = pageStore(
 ...
 * config.url: 请求地址,eg: config.url = 'https://localhost/ngap/api/xxx'
...
function response(response){
    ...
    return (
        <Modal width={'800px'} okText="确认" cancelText="取消" title="高级设置" open={open} onOk={handleOk} onCancel={handleCancel} destroyOnClose>
