        ...
        <>
            ...
            <Form.Item label="通知位置" name={'placement'} rules={[{ required: true, message: '请选择通知位置' }]}>
                <Select placeholder="请选择通知位置">
                    ...
                    <Select.Option value="topLeft">左上方</Select.Option>
                    <Select.Option value="topRight">右上方</Select.Option>
                    <Select.Option value="bottom">下方</Select.Option>
                    <Select.Option value="bottomLeft">左下方</Select.Option>
                    <Select.Option value="bottomRight">右下方</Select.Option>
                </Select>
            </Form.Item>
            <Form.Item
                label="持续时间(秒)"
