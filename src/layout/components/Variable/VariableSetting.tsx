...
const VariableSetting = (_: any, ref: any) => {
    ...
    const { theme, addVariable, editVariable } = pageStore(
    ...
    return (
        <Modal title="添加变量" open={visible} width={650} onOk={handleOk} onCancel={handleCancel} okText="提交" cancelText="取消" destroyOnClose>
