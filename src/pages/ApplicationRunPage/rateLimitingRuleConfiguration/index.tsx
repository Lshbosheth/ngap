...
const Page: React.FC = () => {
    ...
    if (userInfo.addressFlag === 'test') {
        dataSoureUrl = 'http://ngap.cs.cmos:8080/ngapfw/limitRate.html';
    } else {
        dataSoureUrl = 'http://ngap.cs.cmos/ngapfw/limitRate.html';
    }

    return (
        <div className={styles.rateLimitingRuleConfigurationPage}>
