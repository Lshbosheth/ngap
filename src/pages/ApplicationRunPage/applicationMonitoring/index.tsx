...
const Page: React.FC = () => {
    ...
    if (userInfo.addressFlag === 'test') {
        dataSoureUrl = 'http://ngap.cs.cmos:8080/ngaplog/appWarn.html';
    } else {
        dataSoureUrl = 'http://ngap.cs.cmos/ngaplog/appWarn.html';
    }

    return (
        <div className={styles.applicationMonitoringPage}>
