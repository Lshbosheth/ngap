...
import { LinkOutlined, CopyOutlined, UserOutlined, QrcodeOutlined } from '@ant-design/icons';
...
export default memo(() => {
    ...
    const { userInfo, id, isPublic, savePageInfo } = pageStore(
    ...
    return (
        <div className={styles.shareContent}>
            ...
            <div className={styles.footer}>
                <Button color="primary" icon={<LinkOutlined />} onClick={() => window.open(shareLink, '_blank')}>
                    一键访问
                </Button>
                <Tooltip title={<QRCode value={shareLink} type="svg" size={120} />} placement="right" color="var(--ngap-theme-bg-color)">
                    <Button color="primary" icon={<QrcodeOutlined />}>
                        二维码
                    </Button>
                </Tooltip>
            </div>
