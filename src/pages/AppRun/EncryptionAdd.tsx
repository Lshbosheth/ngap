...
const EncryptionAdd: React.FC = () => {
    ...
    if (userInfo.addressFlag === 'test') {
        dataSoureUrl = 'http://ngap.cs.cmos:8080/ngapfw/encryptionAdd.html';
    } else {
        dataSoureUrl = 'http://ngap.cs.cmos/ngapfw/encryptionAdd.html';
    }
