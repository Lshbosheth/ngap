 ...
 * 表格配置
 */
const LinkSetting = memo(({ form, config }: { form: FormInstance; config: any }) => {
    const userInfo = crossApiUserInfo((state: any) => state.userInfo);
     const _state = useAppContext();
        const { pageStore } = _state;
        const {selectedElement,editElement } = pageStore((state: any) => {
            return {
        ...
        <>
                ...
                <div className="left-wrapper">
                    ...
                    {leftValue === 'y' ? (
                        ...
                        ><input
                                ...
                                onChange={(e) => {form.setFieldValue('hrefname', '');}}
                                placeholder="请输入"
                            /></Form.Item > : (
                            <span>
                                <Form.Item
            ...
            >
                <CascadeSelect
                    ...
                    onSure={(data) => {
                        form.setFieldValue('href', data.appTypeId);
