...
import GoldBank from './../../utils/goldbank';

// 框架方法执行
export const GoldBankCheckAction = async (action: GoldBankCheckFnAction, state?: any, callBack?: any) => {
